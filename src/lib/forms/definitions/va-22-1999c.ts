...
export const va221999c: FormDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'No file attachments are needed before downloading. After signing the downloaded form (on or after the 7th calendar day from your enrollment agreement date), return Copy 1 and Copy 2 to your school. Your school submits Copy 1 together with VA Form 22-1999 directly to VA.',
      fields: [],
    },
    {
      id: 'signature',
