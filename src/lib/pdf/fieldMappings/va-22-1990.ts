...
export const va221990Mapping: FieldMapping = {
  ...
  schoolNameAddress: { pdfFieldName: 'form1[0].#subform[3].noandstreet100[0]', type: 'text' },
  ...
  // Service Period 1
  service1Entered: { pdfFieldName: 'form1[0].#subform[4].Dateentered1[0]', type: 'text' },
  service1Separated: { pdfFieldName: 'form1[0].#subform[4].Dateseperated1[0]', type: 'text' },
  ...
  // Service Period 2
  service2Entered: { pdfFieldName: 'form1[0].#subform[4].Dateentered2[0]', type: 'text' },
  service2Separated: { pdfFieldName: 'form1[0].#subform[4].Dateseperated2[0]', type: 'text' },
  ...
  // Service Period 3
  service3Entered: { pdfFieldName: 'form1[0].#subform[4].Dateentered3[0]', type: 'text' },
  service3Separated: { pdfFieldName: 'form1[0].#subform[4].Dateseperated3[0]', type: 'text' },
  service3Branch: { pdfFieldName: 'form1[0].#subform[4].servicecomp3[0]', type: 'text' },

  // ROTC
  seniorROTC: [
    { pdfFieldName: 'form1[0].#subform[4].yes14b[0]', type: 'checkbox', transform: v => v === 'Yes' ? 'true' : '' },
    { pdfFieldName: 'form1[0].#subform[4].no14b[0]', type: 'checkbox', transform: v => v === 'No' ? 'true' : '' },
  ],
  ...
  hsGradDate: { pdfFieldName: 'form1[0].#subform[5].gradyear[0]', type: 'text' },
  faaFlightCerts: [
  ...
  edu1From: { pdfFieldName: 'form1[0].#subform[5].Datetrainfrom1[0]', type: 'text' },
  edu1To: { pdfFieldName: 'form1[0].#subform[5].DateTo1[0]', type: 'text' },
  ...
  edu2From: { pdfFieldName: 'form1[0].#subform[5].Datetrainfrom2[0]', type: 'text' },
  edu2To: { pdfFieldName: 'form1[0].#subform[5].DateTo2[0]', type: 'text' },
  ...
  // ── SIGNATURE (Step 10) ──
  signatureDate: { pdfFieldName: 'form1[0].#subform[6].Datesigned[0]', type: 'text' },
};
