    ...
    <div>
      ...
      <div className="bg-slate-800 text-gray-300 text-xs text-center py-2 px-4">
        <span className="inline-flex flex-wrap items-center justify-center gap-x-4 gap-y-1">
          <span>12 VA Forms Supported</span>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">12 Forms, One Account</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
      ...
      <section id="forms" className="py-20 bg-slate-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-4">12 Supported VA Forms</h2>
          <p className="text-center text-gray-500 mb-12 max-w-2xl mx-auto text-sm">
            From first-time education benefit applications to dependent transfers and work-study —
            all major VA education forms are covered.
          </p>
