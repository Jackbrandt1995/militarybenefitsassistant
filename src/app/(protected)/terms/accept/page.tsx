        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="h-80 overflow-y-auto px-6 py-5 text-sm text-gray-700 leading-relaxed space-y-4 scroll-smooth">
            ...
            <p>
              ...
              transmitted over TLS/HTTPS. Row-Level Security (RLS) rules in the database ensure that only you can
              read or write your own records — no other user can ever access your data.
            </p>
            <p>
